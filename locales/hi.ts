...
export const hi: Record<keyof typeof en, string> = {
  ...
  "mock.banner":
    "डेमो संस्करण. शिकायत दर्ज करना, खाते और 1930 के अलावा के हेल्पलाइन नंबर मॉक हैं.",
  ...
  "bank.mock.title": "यह नंबर केवल नमूना है",
  "bank.mock.body":
    "1800-000-0000 (मॉक नंबर). अपने कार्ड के पीछे छपा नंबर, बैंक का ऐप या आधिकारिक वेबसाइट ही इस्तेमाल करें.",
  ...
  "about.mock.3":
    "बैंक हेल्पलाइन — हर सीडेड नंबर 1800-000-0000 है, स्क्रीन पर लेबल के साथ.",
  "about.mock.4":
