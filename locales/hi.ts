...
export const hi: Record<keyof typeof en, string> = {
  ...
  "about.real.1":
    "पूरा प्रोडक्ट लॉजिक: NCRP की सात वित्तीय-धोखाधड़ी उपश्रेणियों तक ट्राइएज, विवरण रचयिता, पोर्टल की सीमाओं जैसे सत्यापन नियम, एस्केलेशन तिथि-गणित, द्विभाषी सामग्री.",  "about.real.2":
    "सत्र क्रिप्टोग्राफ़िक रूप से हस्ताक्षरित और प्रत्येक सुरक्षित अनुरोध पर सत्यापित होते हैं. डेमो खाते जजिंग के लिए पूर्व-सीडेड हैं. पासवर्ड कभी लॉग नहीं किए जाते. केस डेटा कभी भी उपकरण से बाहर नहीं जाता.",
  "about.real.3":
    "बैंक, वॉलेट और कार्ड-नेटवर्क हेल्पलाइन प्रत्येक संस्था की अपनी वेबसाइट से प्राप्त वास्तविक संख्याएँ हैं, प्रत्येक के साथ स्रोत जुड़ा हुआ है.",
  "about.mock.title": "मॉक",
  "about.mock.1": "लॉगिन खाते हस्ताक्षरित सत्रों वाले पूर्व-सीडेड डेमो उपयोगकर्ता हैं.",
  "about.mock.2":
